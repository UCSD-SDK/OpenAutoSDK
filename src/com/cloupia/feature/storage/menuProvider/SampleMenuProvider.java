package com.cloupia.feature.storage.menuProvider;
 ...
 *
 */
public class SampleMenuProvider extends AbstractTreeNodesProviderIf {
	...
	public List<UIMenuLHTreeNode> getLHTreeNodes() throws Exception {
		...
		DynReportContext dummyContextOneType = ReportContextRegistry.getInstance().getContextByName(StorageConstants.SAMPLE_MENU_CONTEXT_TYPE);
		...
		UIMenuLHTreeNode nodeOne = new UIMenuLHTreeNode("Sample Menu", null, dummyContextOneType.getType(), null);
	...
	public void registerWithProvider() {
		...
		UIMenuLHTreeProvider.getInstance().registerLHTreeNodeProvider( StorageConstants.SAMPLE_MENU_CONTEXT_ID , this );
	}
