...
public class StorageAccountSystemTaskRunAction extends CloupiaPageAction{
	
	static Logger logger = Logger.getLogger(StorageAccountSystemTaskRunAction.class);
	
	private static final String formId = "storageModule.systemTask.run.form";
	private static final String ACTION_ID = "storageModule.systemTask.run.action";
