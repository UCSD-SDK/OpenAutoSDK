 ...
 *
 */
public class StorageSampleForm {
	
	@FormField(label = "Name", help = "Name", rbid = "storageModule.forms.StorageSampleForm.name")
 	private String name;

    @FormField(label = "Value", help = "Value", type = FormFieldDefinition.FIELD_TYPE_EMBEDDED_LOV, lovProvider = SampleLovProvider.SAMPLE_LOV_PROVIDER)
    ...
    @FormField(label = "Multi Select List", type = FormFieldDefinition.FIELD_TYPE_MULTI_SELECT_LIST, lovProvider = SampleLovProvider.SAMPLE_LOV_PROVIDER)
    private String listValue;
    
    @FormField(label = "Upload File", type = FormFieldDefinition.FIELD_TYPE_FILE_UPLOAD)
    private String uploadFileName;
    
    @FormField(label = "Tabular Popup", type = FormFieldDefinition.FIELD_TYPE_TABULAR_POPUP, 
    		table = SampleTabularProvider.SAMPLE_TABULAR_PROVIDER)
    ...
    @FormField(label = "Plain Tabular", type = FormFieldDefinition.FIELD_TYPE_TABULAR, 
    		table = SampleTabularProvider.SAMPLE_TABULAR_PROVIDER, multiline = true)
