 ...
 *
 */
public class FormReportAction extends CloupiaPageAction {

	private static Logger logger = Logger.getLogger(FormReportAction.class);

	//need to provide a unique string to identify this form and action (note: prefix is module id, good practice)
	private static final String formId = "storageModule.report.form";
	private static final String ACTION_ID = "storageModule.report.action";
	...
	public void definePage(Page page, ReportContext context) {
		...
		page.bind(formId, FormReportObject.class);
