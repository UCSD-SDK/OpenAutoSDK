 ...
 *
 */
public class HeatmapReportImpl implements HeatMapReportGeneratorIf {
	/**
	 * Provides HeatMap report generation logic
	 * @param reportEntry : ReportRegistryEntry
	 * @param context : ReportContext
	 * @return : HeatMapReport instance  
	 */
	@Override
